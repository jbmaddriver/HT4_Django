...
class Teacher(models.Model):
    ...
    groups_number_id = models.CharField(
        max_length=20, validators=[validate_comma_separated_integer_list]
    )

    def __str__(self):
        return (f"{self.first_name} {self.last_name} {self.age} {self.science_field} "
                f"{self.science_degree} {self.groups_number_id}")
